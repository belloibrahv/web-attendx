...
export function QRScannerReliable({ onScanSuccess, onScanError, className }: QRScannerReliableProps) {
    ...
    return (
      <Card className={cn("w-full", className)}>
        ...
        <CardContent className="space-y-3 sm:space-y-4">
          ...
          <Button onClick={resetScanner} className="w-full" disabled={isInitializing}>

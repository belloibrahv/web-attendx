  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(0,35,95,0.12),transparent_25%),radial-gradient(circle_at_bottom_right,rgba(191,124,9,0.14),transparent_22%),linear-gradient(135deg,#f8fafc_0%,#eef4ff_42%,#fffaf0_100%)]">
      <header className="fixed left-1/2 top-4 z-50 w-full max-w-6xl -translate-x-1/2 px-4">
        <div className="flex items-center justify-between rounded-2xl border border-white/50 bg-white/90 px-4 py-3 shadow-lg shadow-primary/10 backdrop-blur-xl sm:px-6">
          <BrandMark />
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/register"
              className="hidden rounded-xl border border-primary/15 bg-white px-4 py-2 text-sm font-medium text-primary transition hover:border-primary/25 hover:bg-primary/5 sm:inline-flex"
            >
              Register
            </Link>
            <Link
              href="/login"
              className="inline-flex rounded-xl bg-gradient-to-r from-primary to-accent px-4 py-2 text-sm font-medium text-white shadow-lg shadow-primary/15 transition hover:-translate-y-0.5 hover:shadow-xl"
            >
              Login
            </Link>
          </div>
      ...
      <main className="pt-24">
        <section className="relative overflow-hidden">
          <div className="absolute inset-0">
            <div className="absolute left-4 top-20 h-72 w-72 rounded-full bg-primary/12 blur-3xl" />
            <div className="absolute right-6 top-32 h-96 w-96 rounded-full bg-accent/10 blur-3xl" />
            <div className="absolute bottom-[-40px] left-1/3 h-72 w-72 rounded-full bg-secondary/15 blur-3xl" />
          </div>
            ...
            <div className="grid items-start gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
              <div className="space-y-10">
                <div className="space-y-6">
                  <div className="inline-flex items-center gap-2 rounded-full border border-primary/15 bg-white/70 px-4 py-2 text-sm font-medium text-primary shadow-sm">
                    <span className="h-2 w-2 rounded-full bg-accent" />
                    Institutional Deployment-Ready Attendance Platform
                  </div>

                  <div className="space-y-4">
                    <h1 className="font-heading text-5xl font-bold leading-tight text-slate-950 sm:text-6xl lg:text-7xl">
                      Mobile Attendance
                  ...
                  <div className="flex flex-wrap gap-3">
                    <div className="rounded-full border border-primary/15 bg-white/85 px-4 py-2 text-sm text-slate-700 shadow-sm">
                      <span className="font-semibold text-primary">Department:</span> {schoolProfile.department}
                    </div>
                    <div className="rounded-full border border-primary/15 bg-white/85 px-4 py-2 text-sm text-slate-700 shadow-sm">
                ...
                <div className="flex flex-col gap-4 sm:flex-row">
                  <Link
                    href="/login"
                    className="inline-flex items-center justify-center gap-3 rounded-2xl bg-gradient-to-r from-primary to-accent px-8 py-4 text-lg font-semibold text-white shadow-xl shadow-primary/15 transition hover:-translate-y-1 hover:shadow-2xl"
                  >
                    Access Platform
                  ...
                  <Link
                    href="/register"
                    className="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-white/90 px-8 py-4 text-lg font-semibold text-slate-700 shadow-sm transition hover:-translate-y-0.5 hover:border-primary/20 hover:text-primary"
                  >
                    Register User
                  </Link>
                </div>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {institutionHighlights.map((highlight) => (
                    <div
                      key={highlight}
                      className="rounded-2xl border border-white/60 bg-white/75 px-5 py-4 text-sm leading-7 text-slate-700 shadow-sm backdrop-blur-sm"
                    >
                      {highlight}
                    </div>
                  ))}
              ...
              <div className="relative">
                ...
                <div className="relative overflow-hidden rounded-[2.25rem] border border-slate-200/70 bg-white/90 p-6 shadow-[0_30px_80px_-40px_rgba(0,35,95,0.45)] backdrop-blur-xl sm:p-8">
                  ...
                  <div className="relative space-y-8">
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                      {homepageStats.map((stat) => (
                        <div key={stat.label} className="rounded-2xl border border-slate-200 bg-white/92 p-4 shadow-sm">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="grid gap-3">
                        {operationalPillars.map((pillar) => (
                          <div
                            key={pillar.title}
                            className="flex gap-4 rounded-2xl border border-primary/10 bg-gradient-to-r from-primary/[0.04] to-accent/[0.03] p-4"
                          >
